...
chmod 777 "/var/db/$SITENAME/content/layouts"
chmod g+s "/var/db/$SITENAME/content/layouts"
chmod 777 "/var/db/$SITENAME/content/layouts/partials"
chmod g+s "/var/db/$SITENAME/content/layouts/partials"
chmod 777 "/var/db/$SITENAME/content/layouts/partials/head"
chmod g+s "/var/db/$SITENAME/content/layouts/partials/head"
