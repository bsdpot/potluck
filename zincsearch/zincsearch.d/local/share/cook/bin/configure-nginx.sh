...
mkdir -p /usr/local/www/zincsearch

# set ownership and permissions on web directory
chown www:www /usr/local/www/zincsearch
chmod 755 /usr/local/www/zincsearch
...
cp -f "$TEMPLATEPATH/index.html.in" /usr/local/www/zincsearch/index.html
